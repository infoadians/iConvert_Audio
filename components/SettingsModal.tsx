            ...
            <div className="modal-card">
                ...
                <div className="modal-body overflow-y-auto max-h-[70vh] pr-2">
                    ...
                    <div className="settings-section">
                        ...
                        <a href="https://aistudio.google.com/app/apikey" target="_blank" rel="noopener noreferrer" className="settings-link mt-2 block text-xs">
                            {t.getKey}
                        </a>
                    </div>
                    ...
                    <div className="settings-section">
                        ...
                        <div className="template-form glass-panel p-3">
                            <h5 className="text-xs font-semibold mb-2 uppercase opacity-60">
